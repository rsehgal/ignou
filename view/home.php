...
echo $objSympo->Menu();
echo "<marquee class='font-weight-bold'><mark class='highlight text-danger'>Last date of paper submission has been extended upto 16 September 2023</i></mark></marquee>";
